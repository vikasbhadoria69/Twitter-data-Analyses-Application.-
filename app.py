...
def app():
	...
	if choice=="Tweet Analyzer":
		...
		st.write("2. Generates a Word Cloud from the past 100 tweets of the user")
		st.write("3. Performs Sentiment Analysis of the past 200 tweets a displays it in form of a Bar Graph")
		...
		if st.button("Analyze"):
			...
			if Analyzer_choice == "Show Recent Tweets":
				...
				def Plot_Analysis():
					...
					posts = api.user_timeline(screen_name=raw_text, count = 200, lang ="en", tweet_mode="extended")
		...
		st.subheader("This tool fetches the last 200 tweets from the twitter handel & Performs the following tasks")
	...
	st.subheader(' ------------------------Created By :  Vikas Bhadoria ---------------------- :sunglasses:')
